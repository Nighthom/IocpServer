...
{
	DWORD bytes = 0;
	return SOCKET_ERROR != ::WSAIoctl(socket, SIO_GET_EXTENSION_FUNCTION_POINTER, &guid, sizeof(guid), reinterpret_cast<LPVOID>(fn), sizeof(*fn), OUT &bytes, NULL, NULL);
}
...
bool SocketUtils::Bind(SOCKET socket, NetAddress addr)
{
